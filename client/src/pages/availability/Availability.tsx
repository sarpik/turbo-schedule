					...
					>
						...
						{!wantedParticipants ? null : (
							<p
								...
								`}
							>
								Attention! If you input a wrong name of a student / teacher / class / room, this
								participant will be counted as available in every time interval. This problem will be
								fixed by the time the Beta phase is over (the UI/UX will improve too).
