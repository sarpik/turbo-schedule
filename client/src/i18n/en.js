...
exports.en = {
    ...
    "I am": "I am",
    "Student not found": (name) => `Student "${name}" not found...`,
    ...
    "Email received successfully - thank You for trusting us:)": "Email received successfully - thank You for trusting us:)",
    Enter: "Enter",
    Week: "Week",
    "Go back": "Go back",
    Lesson: "Lesson",
    custom: (count, count2) => `Sup nerd ${count}, how're you doing, ${count2}`,
    Close: "Close",
    Empty__lesson: "Empty",
    Students: "Students",
    Teachers: "Teachers",
    Classes: "Classes",
    Rooms: "Rooms",
    toCompactString: (items) => items.length > 1 ? `${items[0]} and ${items.length - 1} more` : items[0],
    "Made with love by (__html)": `Made with <span aria-label="love">❤</span> by`,
    Availability: "Availability",
    Common: "Common",
    "Common Availability": "Common availability",
    "There're often situations when you have a group of people and want to find a common time to meet": "There're often situations when you have a group of people and want to find a common time to meet",
    ...
    "The UI/UX will be improved by the time the Beta phase is over": "The UI/UX will be improved by the time the Beta phase is over",
